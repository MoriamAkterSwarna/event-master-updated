  ...
  return (
    <div  className="company-details px-1 lg:px-24 z-40 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3">
      ...
      <div className="bg-white lg:h-[85%] my-[7%] p-5 mx-10 hover:border-b-8 hover:border-b-orange-500 relative">
       ...
       <div className="flex items-center justify-between absolute bottom-8">
       <p className="text-xl font-semibold ">Get to Know Our Methodology
          </p> 
      ...
      <div className="bg-white lg:h-[85%] my-[7%] p-5 mx-10 hover:border-b-8 hover:border-b-orange-500 relative">
       ...
       <div className="flex mt-6 items-center justify-between absolute bottom-8">
       <p className="text-xl font-semibold">Know more about our team 
          </p> 
          <BiRightArrowCircle className="w-8 h-8 text-orange-500" />
       </div>
      </div>
      ...
      <div className="bg-white lg:h-[85%] my-[7%] p-5 mx-10 hover:border-b-8 hover:border-b-orange-500 relative">
        ...
        <p className="text-justify">We believe that every event has a unique story waiting to unfold. From intimate gatherings to grand celebrations, we carefully listen to our clients' desires, immerse ourselves in their aspirations, and blend our creativity with meticulous attention to detail. This harmonious fusion allows us to transform visions into reality, weaving together the elements that make each event extraordinary.</p>

        
       <div className="flex mt-6 items-center justify-between absolute bottom-8">
       <p className="text-xl font-semibold ">Gain Insight into what we are 
          </p> 
          <BiRightArrowCircle className="w-8 h-8 text-orange-500" />
       </div>
      </div>
