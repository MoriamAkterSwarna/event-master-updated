      ...
      <div ref={sliderRef} className="keen-slider w-full lg:mt-0">
        <div className="keen-slider__slide number-slide1">
          ...
          <div className="mx-auto absolute left-[10%] md:top-[40%] top-32 md:left-[20%] lg:top-32  lg:left-[36%] text-white">
            ...
            <Link
              href="/registerEvent"
              className="bg-gradient-to-br from-orange-400 via-orange-500 to-yellow-300 hover:bg-gradient-to-br hover:from-yellow-400 hover:via-orange-500 hover:to-yellow-500 text-white font-semibold py-3 px-6 rounded-full mt-6">
              Plan An Event
            </Link>
